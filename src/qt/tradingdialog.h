...
private slots:
    ...
    QString BuyGNR(QString OrderType, double Quantity, double Rate);
    QString SellGNR(QString OrderType, double Quantity, double Rate);
